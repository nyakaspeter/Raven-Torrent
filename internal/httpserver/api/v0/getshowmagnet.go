...
// @Param providers path string true "Torrent providers to use, separated by comma. Possible values: jackett, ncore, insane, eztv, 1337x, itorrent" example(jackett,eztv)
